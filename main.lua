...
function dssWorkshopMod.GetSaveData()
    if not dssWorkshopMod.menusavedata then
        if Isaac.HasModData(dssWorkshopMod) then
            dssWorkshopMod.menusavedata = json.decode(Isaac.LoadModData(dssWorkshopMod))
        else
            dssWorkshopMod.menusavedata = {}
        end
    end

    return dssWorkshopMod.menusavedata
end

function dssWorkshopMod.StoreSaveData()
    Isaac.SaveModData(dssWorkshopMod, json.encode(dssWorkshopMod.menusavedata))
end

function MenuProvider.SaveSaveData()
    dssWorkshopMod.StoreSaveData()
end

function MenuProvider.GetPaletteSetting()
    return dssWorkshopMod.GetSaveData().MenuPalette
end

function MenuProvider.SavePaletteSetting(var)
    dssWorkshopMod.GetSaveData().MenuPalette = var
end
...
function MenuProvider.GetGamepadToggleSetting()
    return dssWorkshopMod.GetSaveData().GamepadToggle
end

function MenuProvider.SaveGamepadToggleSetting(var)
    dssWorkshopMod.GetSaveData().GamepadToggle = var
end

function MenuProvider.GetMenuKeybindSetting()
    return dssWorkshopMod.GetSaveData().MenuKeybind
end

function MenuProvider.SaveMenuKeybindSetting(var)
    dssWorkshopMod.GetSaveData().MenuKeybind = var
end

function MenuProvider.GetMenusNotified()
    return dssWorkshopMod.GetSaveData().MenusNotified
end

function MenuProvider.SaveMenusNotified(var)
    dssWorkshopMod.GetSaveData().MenusNotified = var
end

function MenuProvider.GetMenusPoppedUp()
    return dssWorkshopMod.GetSaveData().MenusPoppedUp
end
...
-- If you're embedding / running the menu with luamod, consider using a fake error function here at the end of the file.
